...
<div class="container-fluid">
    ...
    <div class="col-sm-7">
        ...
        13353 Berlin<br></p><br>
          
        <p><strong>Ein Projekt aus Softwareprojekt II - Sommersemester 2016<br></strong>
        <strong>Betreuer:</strong>
          Michael<br>
        <strong>Mitglieder der Gruppe:</strong>
          Bernd, Günay, Timo, Oliver und Sven
          
        </p>
        <p>GitHub: <a href="https://github.com/mitchobrian/schere-stein-papier/">github.com/mitchobrian/schere-stein-papier</a></p>
    ...
    <div class="col-sm-5">
        <h1></h1>
        <img src="images/beuth_logo.png" width="300" height="100">
    </div>
</div>
...
<div class="col-sm-12">
    ...
    <!-- ANDERS EINSETZEN?     
        <p>Quelle: <a href="http://www.fachanwalt.de/disclaimer-vorlage/">Disclaimer Vorlage</a> powered by <a href="http://www.fachanwalt.de/">fachanwalt.de</a></p>
-->
